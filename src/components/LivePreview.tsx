...
const LivePreview: React.FC<LivePreviewProps> = ({
  ...
  return (
    <div className="appointment-document" role="document" aria-label="MCAN Appointment Letter">
      <div className="document">
        ...
        <div className="relative z-10">
          ...
          <div className="content" role="main">
            {isAdHoc ? (
              <>
                ...
                {adHocData?.customDuties && adHocData.customDuties.length > 0 && (
                  <>
                    <br /><br />
                    <strong>Duties and Responsibilities:</strong>
                    <ul style={{ marginTop: '10px', paddingLeft: '20px' }}>
                      {adHocData.customDuties.map((duty, index) => (
                        <li key={index} style={{ marginBottom: '5px' }}>{duty}</li>
                      ))}
                    </ul>
                  </>
                )}
          ...
          {/* Congratulations */}
          <div className="congratulations" role="complementary">
            Congratulations!
          </div>

          {/* Date and Signature section aligned horizontally */}
          <div className="date-signature-container" role="contentinfo">
            ...
            <div className="signature-section">
              <div className="signature-left">
                ...
                <div className="signature-line" aria-label="Signature line"></div>
